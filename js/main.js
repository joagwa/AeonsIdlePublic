...
// === Core Imports ===
import { ErrorReporter } from './core/ErrorReporter.js?v=bc1646d';
import { LogBuffer } from './core/LogBuffer.js?v=bc1646d';
import { EventBus } from './core/EventBus.js?v=bc1646d';
import { GameLoop } from './core/GameLoop.js?v=bc1646d';
import { formatNumber, setNotationMode, getNotationMode } from './core/NumberFormatter.js?v=bc1646d';
import { SaveSystem } from './core/SaveSystem.js?v=bc1646d';
import { UpdateChecker } from './core/UpdateChecker.js?v=bc1646d';

// === Engine Imports ===
import { ResourceManager } from './engine/ResourceManager.js?v=bc1646d';
import { UpgradeSystem } from './engine/UpgradeSystem.js?v=bc1646d';
import { MilestoneSystem } from './engine/MilestoneSystem.js?v=bc1646d';
import { StarManager } from './engine/StarManager.js?v=bc1646d';
import { EpochSystem } from './engine/EpochSystem.js?v=bc1646d';
import { MoteController } from './engine/MoteController.js?v=bc1646d';
import { ProceduralMoteGenerator } from './engine/ProceduralMoteGenerator.js?v=bc1646d';
import { DarkMatterSystem } from './engine/DarkMatterSystem.js?v=bc1646d';
import { AutoBuySystem } from './engine/AutoBuySystem.js?v=bc1646d';

// === Renderer Imports ===
import { CanvasRenderer } from './renderer/CanvasRenderer.js?v=bc1646d';

// === UI Imports ===
import { ResourcePanel } from './ui/ResourcePanel.js?v=bc1646d';
import { UpgradePanel } from './ui/UpgradePanel.js?v=bc1646d';
import { MilestoneNotification } from './ui/MilestoneNotification.js?v=bc1646d';
import { ChroniclePanel } from './ui/ChroniclePanel.js?v=bc1646d';
import { SettingsPanel } from './ui/SettingsPanel.js?v=bc1646d';
import { OfflineProgress } from './ui/OfflineProgress.js?v=bc1646d';
import { EpochTransitionOverlay } from './ui/EpochTransitionOverlay.js?v=bc1646d';
import { ResidualBonusPanel } from './ui/ResidualBonusPanel.js?v=bc1646d';
import { StatsPanel } from './ui/StatsPanel.js?v=bc1646d';
import { GoalWidget } from './ui/GoalWidget.js?v=bc1646d';
import { MobileTabBar } from './ui/MobileTabBar.js?v=bc1646d';
import { FeedbackPanel } from './ui/FeedbackPanel.js?v=bc1646d';
