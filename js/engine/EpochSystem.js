...
export class EpochSystem {
  /** @type {import('../core/EventBus.js?v=b7910b1').EventBus} */
  #eventBus;
  /** @type {import('./ResourceManager.js?v=b7910b1').ResourceManager} */
  #resourceManager;
  /** @type {import('./UpgradeSystem.js?v=b7910b1').UpgradeSystem} */
  #upgradeSystem;
  /** @type {import('./MilestoneSystem.js?v=b7910b1').MilestoneSystem} */
  #milestoneSystem;
  /** @type {import('./StarManager.js?v=b7910b1').StarManager} */
  #starManager;
  ...
  /**
   * @param {import('../core/EventBus.js?v=b7910b1').EventBus} EventBus
   * @param {import('./ResourceManager.js?v=b7910b1').ResourceManager} resourceManager
   * @param {import('./UpgradeSystem.js?v=b7910b1').UpgradeSystem} upgradeSystem
   * @param {import('./MilestoneSystem.js?v=b7910b1').MilestoneSystem} milestoneSystem
   * @param {import('./StarManager.js?v=b7910b1').StarManager} starManager
      ...
      try {
        if (epochId === 'epoch1') {
          const [dataModule, canvasModule] = await Promise.all([
            import('../data/epoch1.js?v=b7910b1'),
            import('../data/epoch1-canvas.js?v=b7910b1'),
          ]);
