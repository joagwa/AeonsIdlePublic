...
export class EpochSystem {
  /** @type {import('../core/EventBus.js?v=28ddd1c').EventBus} */
  #eventBus;
  /** @type {import('./ResourceManager.js?v=28ddd1c').ResourceManager} */
  #resourceManager;
  /** @type {import('./UpgradeSystem.js?v=28ddd1c').UpgradeSystem} */
  #upgradeSystem;
  /** @type {import('./MilestoneSystem.js?v=28ddd1c').MilestoneSystem} */
  #milestoneSystem;
  /** @type {import('./StarManager.js?v=28ddd1c').StarManager} */
  #starManager;
  ...
  /**
   * @param {import('../core/EventBus.js?v=28ddd1c').EventBus} EventBus
   * @param {import('./ResourceManager.js?v=28ddd1c').ResourceManager} resourceManager
   * @param {import('./UpgradeSystem.js?v=28ddd1c').UpgradeSystem} upgradeSystem
   * @param {import('./MilestoneSystem.js?v=28ddd1c').MilestoneSystem} milestoneSystem
   * @param {import('./StarManager.js?v=28ddd1c').StarManager} starManager
      ...
      try {
        if (epochId === 'epoch1') {
          const [dataModule, canvasModule] = await Promise.all([
            import('../data/epoch1.js?v=28ddd1c'),
            import('../data/epoch1-canvas.js?v=28ddd1c'),
          ]);
