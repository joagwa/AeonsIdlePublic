...
export class EpochSystem {
  /** @type {import('../core/EventBus.js?v=b57db20').EventBus} */
  #eventBus;
  /** @type {import('./ResourceManager.js?v=b57db20').ResourceManager} */
  #resourceManager;
  /** @type {import('./UpgradeSystem.js?v=b57db20').UpgradeSystem} */
  #upgradeSystem;
  /** @type {import('./MilestoneSystem.js?v=b57db20').MilestoneSystem} */
  #milestoneSystem;
  /** @type {import('./StarManager.js?v=b57db20').StarManager} */
  #starManager;
   ...
   * @param {import('./ResourceManager.js?v=b57db20').ResourceManager} resourceManager
   * @param {import('./UpgradeSystem.js?v=b57db20').UpgradeSystem} upgradeSystem
   * @param {import('./MilestoneSystem.js?v=b57db20').MilestoneSystem} milestoneSystem
   * @param {import('./StarManager.js?v=b57db20').StarManager} starManager
      ...
      try {
        if (epochId === 'epoch1') {
          const [dataModule, canvasModule] = await Promise.all([
            import('../data/epoch1.js?v=b57db20'),
            import('../data/epoch1-canvas.js?v=b57db20'),
          ]);
