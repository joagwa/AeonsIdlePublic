...
export class EpochSystem {
  ...
  #resourceManager;
  /** @type {import('./UpgradeSystem.js?v=688067a').UpgradeSystem} */
  #upgradeSystem;
  /** @type {import('./MilestoneSystem.js?v=688067a').MilestoneSystem} */
  #milestoneSystem;
  /** @type {import('./StarManager.js?v=688067a').StarManager} */
  #starManager;
   ...
   * @param {import('./ResourceManager.js?v=688067a').ResourceManager} resourceManager
   * @param {import('./UpgradeSystem.js?v=688067a').UpgradeSystem} upgradeSystem
   * @param {import('./MilestoneSystem.js?v=688067a').MilestoneSystem} milestoneSystem
   * @param {import('./StarManager.js?v=688067a').StarManager} starManager
      ...
      try {
        if (epochId === 'epoch1') {
          const [dataModule, canvasModule] = await Promise.all([
            import('../data/epoch1.js?v=688067a'),
            import('../data/epoch1-canvas.js?v=688067a'),
          ]);
