...
export class EpochSystem {
  /** @type {import('../core/EventBus.js?v=ff2c227').EventBus} */
  #eventBus;
  /** @type {import('./ResourceManager.js?v=ff2c227').ResourceManager} */
  #resourceManager;
  /** @type {import('./UpgradeSystem.js?v=ff2c227').UpgradeSystem} */
  #upgradeSystem;
  /** @type {import('./MilestoneSystem.js?v=ff2c227').MilestoneSystem} */
  #milestoneSystem;
  /** @type {import('./StarManager.js?v=ff2c227').StarManager} */
  #starManager;
   ...
   * @param {import('./ResourceManager.js?v=ff2c227').ResourceManager} resourceManager
   * @param {import('./UpgradeSystem.js?v=ff2c227').UpgradeSystem} upgradeSystem
   * @param {import('./MilestoneSystem.js?v=ff2c227').MilestoneSystem} milestoneSystem
   * @param {import('./StarManager.js?v=ff2c227').StarManager} starManager
      ...
      try {
        if (epochId === 'epoch1') {
          const [dataModule, canvasModule] = await Promise.all([
            import('../data/epoch1.js?v=ff2c227'),
            import('../data/epoch1-canvas.js?v=ff2c227'),
          ]);
