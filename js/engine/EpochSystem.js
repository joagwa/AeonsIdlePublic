...
export class EpochSystem {
  ...
  #resourceManager;
  /** @type {import('./UpgradeSystem.js?v=2e4f878').UpgradeSystem} */
  #upgradeSystem;
  /** @type {import('./MilestoneSystem.js?v=2e4f878').MilestoneSystem} */
  #milestoneSystem;
  /** @type {import('./StarManager.js?v=2e4f878').StarManager} */
  #starManager;
   ...
   * @param {import('./ResourceManager.js?v=2e4f878').ResourceManager} resourceManager
   * @param {import('./UpgradeSystem.js?v=2e4f878').UpgradeSystem} upgradeSystem
   * @param {import('./MilestoneSystem.js?v=2e4f878').MilestoneSystem} milestoneSystem
   * @param {import('./StarManager.js?v=2e4f878').StarManager} starManager
      ...
      try {
        if (epochId === 'epoch1') {
          const [dataModule, canvasModule] = await Promise.all([
            import('../data/epoch1.js?v=2e4f878'),
            import('../data/epoch1-canvas.js?v=2e4f878'),
          ]);
