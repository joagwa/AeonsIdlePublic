...
export class EpochSystem {
  /** @type {import('../core/EventBus.js?v=6cd1d3d').EventBus} */
  #eventBus;
  /** @type {import('./ResourceManager.js?v=6cd1d3d').ResourceManager} */
  #resourceManager;
  /** @type {import('./UpgradeSystem.js?v=6cd1d3d').UpgradeSystem} */
  #upgradeSystem;
  /** @type {import('./MilestoneSystem.js?v=6cd1d3d').MilestoneSystem} */
  #milestoneSystem;
  /** @type {import('./StarManager.js?v=6cd1d3d').StarManager} */
  #starManager;
  ...
  /**
   * @param {import('../core/EventBus.js?v=6cd1d3d').EventBus} EventBus
   * @param {import('./ResourceManager.js?v=6cd1d3d').ResourceManager} resourceManager
   * @param {import('./UpgradeSystem.js?v=6cd1d3d').UpgradeSystem} upgradeSystem
   * @param {import('./MilestoneSystem.js?v=6cd1d3d').MilestoneSystem} milestoneSystem
   * @param {import('./StarManager.js?v=6cd1d3d').StarManager} starManager
      ...
      try {
        if (epochId === 'epoch1') {
          const [dataModule, canvasModule] = await Promise.all([
            import('../data/epoch1.js?v=6cd1d3d'),
            import('../data/epoch1-canvas.js?v=6cd1d3d'),
          ]);
