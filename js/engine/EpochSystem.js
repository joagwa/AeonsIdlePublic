...
export class EpochSystem {
  /** @type {import('../core/EventBus.js?v=2aa356b').EventBus} */
  #eventBus;
  /** @type {import('./ResourceManager.js?v=2aa356b').ResourceManager} */
  #resourceManager;
  /** @type {import('./UpgradeSystem.js?v=2aa356b').UpgradeSystem} */
  #upgradeSystem;
  /** @type {import('./MilestoneSystem.js?v=2aa356b').MilestoneSystem} */
  #milestoneSystem;
  /** @type {import('./StarManager.js?v=2aa356b').StarManager} */
  #starManager;
   ...
   * @param {import('./ResourceManager.js?v=2aa356b').ResourceManager} resourceManager
   * @param {import('./UpgradeSystem.js?v=2aa356b').UpgradeSystem} upgradeSystem
   * @param {import('./MilestoneSystem.js?v=2aa356b').MilestoneSystem} milestoneSystem
   * @param {import('./StarManager.js?v=2aa356b').StarManager} starManager
      ...
      try {
        if (epochId === 'epoch1') {
          const [dataModule, canvasModule] = await Promise.all([
            import('../data/epoch1.js?v=2aa356b'),
            import('../data/epoch1-canvas.js?v=2aa356b'),
          ]);
