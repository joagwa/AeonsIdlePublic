...
import { SpriteManager } from './SpriteManager.js?v=2e4f878';
import { Camera } from './Camera.js?v=2e4f878';
import { ParticleSystem } from './ParticleSystem.js?v=2e4f878';
import { RegionManager } from './RegionManager.js?v=2e4f878';
import { FloatingNumbers } from './FloatingNumbers.js?v=2e4f878';
...
export class CanvasRenderer {
  constructor(EventBus) {
    ...
    /** @type {import('../engine/DarkMatterSystem.js?v=2e4f878').DarkMatterSystem|null} */
   ...
   * @param {import('../engine/DarkMatterSystem.js?v=2e4f878').DarkMatterSystem} sys
   */
