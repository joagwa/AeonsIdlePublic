...
import { SpriteManager } from './SpriteManager.js?v=5cffe26';
import { Camera } from './Camera.js?v=5cffe26';
import { ParticleSystem } from './ParticleSystem.js?v=5cffe26';
import { RegionManager } from './RegionManager.js?v=5cffe26';
import { FloatingNumbers } from './FloatingNumbers.js?v=5cffe26';
...
export class CanvasRenderer {
  constructor(EventBus) {
    ...
    /** @type {import('../engine/DarkMatterSystem.js?v=5cffe26').DarkMatterSystem|null} */
   ...
   * @param {import('../engine/DarkMatterSystem.js?v=5cffe26').DarkMatterSystem} sys
   */
